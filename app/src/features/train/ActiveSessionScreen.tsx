      ...
      <div className="mb-3 flex items-center justify-between gap-2">
        <div className="min-w-0">
          ...
          {isRoutineSession && sortedRoutineExercises.length > 0 && (
            <div
              className="mt-1 inline-flex rounded-full px-3 py-1 text-[10px] font-black uppercase tracking-widest"
        ...
        <span
          ...
          style={{ background: 'var(--color-bg-elevated)', color: 'var(--color-text-muted)', boxShadow: '0 8px 30px rgb(0,0,0,0.04)' }}
        >
